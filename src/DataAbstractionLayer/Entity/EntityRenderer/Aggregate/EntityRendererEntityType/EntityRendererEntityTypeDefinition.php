...
namespace Ovv\Entity\DataAbstractionLayer\Entity\EntityRenderer\Aggregate\EntityRendererEntityType;
...
class EntityRendererEntityTypeDefinition extends MappingEntityDefinition
{
    final public const ENTITY_NAME = 'ovv_entity_renderer_entity_type';
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            (new FkField('type_id', 'typeId', EntityTypeDefinition::class))->addFlags(new PrimaryKey(), new Required()),
