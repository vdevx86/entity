import template from './ovv-entity-type-detail.html.twig';
import './ovv-entity-type-detail.scss';
    ...
    methods: {
        ...
        onSave() {
            ...
            this.repository.save(this.entity, this.context).then(() => {
                if (isNew) {
                    this.$router.push({ name: 'ovv.entity.type.detail', params: { id: this.entity.id } });
                } else {
        ...
        onCancel() {
            this.$router.push({ name: 'ovv.entity.type.index' });
        },
